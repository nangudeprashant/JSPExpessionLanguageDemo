...
<% 	List<String> names = new ArrayList<String>();
	names.add("ListName1");names.add("ListName2");
	pageContext.setAttribute("names", names);
%>
<strong>Simple EL Example:(Request Scope Person Details)</strong> ${requestScope.person}
<br><br>
<strong>Simple EL Example without scope:(Person Details without Request Scope)</strong> ${person}
<%-- <br><br>
<strong>Simple [] Example:</strong> ${applicationScope["User.Cookie"]} --%>
<br><br>
<strong>Multiples EL Example(Session Scope Employee Details):</strong> ${sessionScope.employee}
<br><br>
<strong>List EL Example:</strong> ${names[0]}<br>
